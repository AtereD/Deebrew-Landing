...
const Explore = () => {
  return (
    <section className="py-12 xl:py-0 xl:h-[90vh] xl:w-screen" id="explore">
      <div className="containers mx-auto xl:w-full xl:h-full flex xl:justify-center xl:items-center">
        <div className=" w-full flex flex-col lg:flex-row gap-12 xl:gap-20">
          ...
          <div className="hidden xl:flex justify-center">
            <div className="relative w-[322px] h-[520px]">
              <Image
          ...
          <div className="flex-1 flex flex-col justify-center text-center xl:text-left gap-12  max-w-[400px] mx-auto xl:max-w-none xl:mx-0">
            <div className="relative flex items-start">
